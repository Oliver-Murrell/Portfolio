...
//   }, []);
//   return (
//     <section id="projects" className="max-w-6xl mx-auto p-6 text-center">
//       <h3 className="text-3xl font-bold">Projects</h3>
//       {loading ? (
//         <p className="mt-6 opacity-70">Loading projects...</p>
//       ) : (
//         <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
//           {items.map((p) => (
//             <motion.a key={p.id} href={p.link} target="_blank" rel="noopener noreferrer" whileHover={{ y: -5 }} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition overflow-hidden w-full max-w-sm text-left">
//               {p.image && <img src={p.image} alt={p.title} className="w-full h-40 object-cover" />}
//               <div className="p-5">
//                 <h4 className="text-lg font-semibold">{p.title}</h4>
//                 <p className="text-sm mt-2 opacity-80">{p.summary}</p>
