...
//   // Anchor wrapper for the button + dropdown (for outside click logic)
...
//   // Auto-close menu when viewport becomes md+ (so it doesn't linger)
//   React.useEffect(() => {
...
//   // Desktop link styling (keeps dark variants; no theme toggle anywhere)
...
//             {/* Hamburger button (now shows finger pointer on hover) */}
//             <button
//               type="button"
//               className="p-2 rounded-md border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 hover:cursor-pointer"
//               onClick={(e) => {
...
//             {/* Anchored dropdown panel (right-aligned to button) */}
//             {open && (
//               <div
//                 role="menu"
//                 className="
...
//                       key={item.id}
//                       href={`#${item.id}`}
//                       className="px-3 py-2 rounded-md border border-transparent hover:border-gray-300 dark:hover:border-gray-700"
...
//         <div className="absolute right-6 flex items-center gap-4">
//           <div ref={anchorRef} className="relative md:hidden">
//             {/* Menu button with same hover effects as hero buttons */}
//             <button
//               type="button"
//               className="p-2 rounded-full border border-gray-300 dark:border-gray-700 shadow text-gray-900 dark:text-gray-100 transition hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer"
//               onClick={(e) => {
//                 e.stopPropagation();
//                 toggleMenu();
//               }}
